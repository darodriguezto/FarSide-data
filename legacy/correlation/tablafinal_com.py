...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 28 22:50:09 2024
...
def main(year):
    ...
    archivo_salida=os.path.join(carpeta,'tabla_completa.csv')
    # Cargar el archivo CSV en un DataFrame
    archivo_entrada=os.path.join(carpeta,"tabla_combinada_completa.csv")
