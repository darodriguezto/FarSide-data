...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 15 12:42:32 2025
...
def main(year):
    ...
    archivo_salida = os.path.join(carpeta_salida, 'datos_resultado_ordenadosX.csv')
    patron_fecha = re.compile(r'\d{4}\.\d{2}\.\d{2}')
    
    datos_a, datos_b, fechas, Strength, prediction, latitude = [], [], [], [], [], []
