...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 30 22:26:02 2024
...
def main(year):
    ...
    archivo_entrada = os.path.join(carpeta_base, 'new_combined_data_last.csv')
    df= pd.read_csv(archivo_entrada)
    
    archivo_salida=os.path.join( carpeta_base, 'archivo_agrupado_por_semana_last.csv')
    graph= os.path.join(carpeta_base, 'Predicted vs Deteceted by week_last.png')
