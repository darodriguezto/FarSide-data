...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 30 22:13:11 2024
...
def main(year):
    ...
    farside = os.path.join (carpeta_base, 'AR_agrupadas_last.csv')
    nearside= os.path.join(carpeta_base,'ARatEastLimb_histogram_data_corr.csv')
    
    archivo_salida=os.path.join(carpeta_base,'new_combined_data_last.csv' )
