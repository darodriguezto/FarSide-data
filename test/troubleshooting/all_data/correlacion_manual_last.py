...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 30 22:22:10 2024
...
def main(year):    
    # Abrir el archivo
    archivo_nombre = 'archivo_normalizado_last.csv'
    ...
    output_file = os.path.join(carpeta_base, 'correlaciones_lags_prueba_last.csv')
    ...
    # Guardar gráfico
    grafico_file = os.path.join(carpeta_base, 'correlacion_vs_lag_last.png')
    ...
    output_acumulado = 'correlaciones_acumuladas_last.csv'
