...
# -*- coding: utf-8 -*-
"""
Created on Mon May 27 12:48:16 2024
...
for day in range(1, 31):
    day_str=str(day)
    if day<10:
        url_imagen = "http://jsoc.stanford.edu/data/farside/AR_Maps_JPEG/2022/AR_MAP_2022.04.0"+day_str+"_00:00:00.png"
    else :
        url_imagen = "http://jsoc.stanford.edu/data/farside/AR_Maps_JPEG/2022/AR_MAP_2022.04."+day_str+"_00:00:00.png"   
        # Nombre que quieres darle al archivo descargado
    nombre_archivo = f"{day}_0.png"
    if day<10:
        url_imagen12 = "http://jsoc.stanford.edu/data/farside/AR_Maps_JPEG/2022/AR_MAP_2022.04.0"+day_str+"_12:00:00.png"
    else :
        url_imagen12 = "http://jsoc.stanford.edu/data/farside/AR_Maps_JPEG/2022/AR_MAP_2022.04."+day_str+"_12:00:00.png"   
        # Nombre que quieres darle al archivo descargado
