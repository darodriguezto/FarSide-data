...
# -*- coding: utf-8 -*-
"""
Created on Wed May 29 22:09:05 2024
...
df = pd.read_csv('AR_EastLimb_corr.csv')
...
date_counts.to_csv('ARatEastLimb_histogram_data_corr.csv', index=False)

# Imprimir las primeras filas del DataFrame guardado como CSV
print(pd.read_csv('ARatEastLimb_histogram_data_corr.csv'))
