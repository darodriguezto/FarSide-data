...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 28 22:47:22 2024
...
def main(year):
    ...
    archivo_csv=os.path.expanduser(f"~/Documentos/GoSA/Far_Side/FarSide-data/correlation/{year}/ETA_modified_completeweek.csv")
    df = pd.read_csv(archivo_csv)
    rutasalida= os.path.join(carpeta,'semanasagrupadas_completas.csv')
