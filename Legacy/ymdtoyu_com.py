...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 28 21:15:52 2024

@author: daniel
"""

#PROGRAMA PARA PASAR DE FECHA A SEMANAS (completa) EN LA SEGUNDA COLUMNA
...
# Nombre del archivo CSV de entrada y salida
    ...
    nombre_archivo_csv_salida = os.path.join(carpeta, 'ETA_modified_completeweek.csv')
