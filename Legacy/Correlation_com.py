...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 28 22:53:48 2024
...
file = f"~/Documentos/GoSA/Far_Side/FarSide-data/correlation/{args.year}/tabla_completa.csv"
...
plt.savefig(os.path.expanduser(f'~/Documentos/GoSA/Far_Side/FarSide-data/correlation/{args.year}/ambas(semanas_completas).png'))
plt.show()

# Graficar la autocorrelación para ambas series
plot_acf(Near, lags=13, title='Autocorrelación para el # de Nuevas AR')
plt.savefig(os.path.expanduser(f'~/Documentos/GoSA/Far_Side/FarSide-data/correlation/{args.year}/autonear(semanas_completas).png'))
plt.show()

plot_acf(Far, lags=13, title='Autocorrelación para el Strength promedio')
plt.savefig(os.path.expanduser(f'~/Documentos/GoSA/Far_Side/FarSide-data/correlation/{args.year}/autofar(semanas_completas).png'))
plt.show()
...
plt.savefig(os.path.expanduser(f'~/Documentos/GoSA/Far_Side/FarSide-data/correlation/{args.year}/crosscorrelation_{args.year}(semanas_completas).png'))
plt.show()
